...
require_once __DIR__.'/PdoController.php';

$pdo = new PdoController;

$pdo->reset();
$pdo->tableName = 'users';//// database table name
$pdo->tableKey = ['username','password','email','img'];//// database table key
$pdo->ControllerName = 'UsersControllerPdo'; ///// crud class function name
$pdo->CrudCreate(); //// crud function create